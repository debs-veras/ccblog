  ...
  return (
    ...
    >
      ...
      <div className="mt-2 grid gap-2 border-l border-[#112b3c] dark:border-sky-500 pl-4 md:grid-cols-2 transition-all duration-500">
        {/* título */}
        <p className="min-w-0 text-base font-bold leading-snug md:text-lg line-clamp-3  dark:group-hover:text-sky-400 transition-colors duration-300 text-slate-900 dark:text-white">
          {post.title}
        </p>
