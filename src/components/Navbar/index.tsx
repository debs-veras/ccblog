...
export default function Navbar() {
  ...
  return (    <nav
    ...
    >
      <div className="container mx-auto px-6 lg:px-12 transition-all duration-300">
            ...
            <div className="flex items-center bg-slate-100/50 dark:bg-slate-900/50 p-1.5 rounded-full border border-slate-200/50 dark:border-slate-800/50 backdrop-blur-md">
              {navLinks.map((link) => (
                <NavLink
                  ...
                  to={link.path}
                  className={({ isActive }) =>
                    `px-2 xl:px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.05em] xl:tracking-[0.15em] transition-all duration-300 whitespace-nowrap ${
                      isActive
