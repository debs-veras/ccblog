...
export default function NewsDetail() {
  ...
  return (
    ...
    >
      {/* HERO */}
      <section className="w-full pt-12 pb-10 border-b border-slate-200">
        <div className="space-y-6">
          {/* VOLTAR */}
          <Link
            to="/noticias"
            className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-slate-900 transition"
          >
          ...
          {post.category && (
            <motion.span
              ...
              className="inline-block bg-primary/10 text-primary px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider"
            >
              {post.category.name}
            </motion.span>
          )}
          ...
          <div className="flex flex-wrap justify-between items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-200 hover:border-primary hover:text-primary transition text-sm"
            >
      ...
      <section className="flex-1 pt-10 space-y-8">
        ...
        {/* DESCRIPTION */}
        {post.description && (
          <p className="text-lg text-slate-600 italic border-l-4 border-primary/40 pl-5">
            {post.description}
          </p>
        )}
